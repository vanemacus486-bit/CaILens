...
export function SettingsAbout() {
  ...
  const openLatestRelease = () => openExternal(RELEASES_PAGE)
          ...
          {isTauri() && (
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-border-default px-3 py-1.5 text-xs font-sans font-medium text-text-secondary hover:text-text-primary hover:bg-surface-base transition-colors duration-200 cursor-pointer"
              >
