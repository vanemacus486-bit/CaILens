      ...
      <div className="flex items-center gap-2.5">
        ...
        {editingBudget ? (
          <input
            ...
            className="w-12 px-1.5 py-0.5 text-xs font-mono text-text-primary bg-surface-sunken border border-border-subtle rounded text-center focus:border-border-default focus-visible:outline-none"
            autoFocus
          />
        ) : (
          <button
            onClick={handleBudgetClick}
            className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-xs font-mono bg-surface-sunken text-text-secondary hover:text-text-primary cursor-pointer transition-colors duration-150 border-none"
          >
