...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn('fixed inset-0 z-50 bg-black/30 dark:bg-black/50', className)}
    {...props}
  />
))
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-sm rounded-xl border border-border-subtle bg-surface-raised p-6 shadow-[0_10px_40px_rgba(0,0,0,0.15)]',
        'outline-none',
        className,
      )}
      {...props}
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-base font-semibold text-text-primary font-sans', className)}
    {...props}
  />
))
