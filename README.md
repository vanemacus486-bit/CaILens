...
> **状态：** v3.16.0 加密导出、AI 事件反链、对话摘要、霞鹜文楷字体——批量粘贴、加密 .cailens 导出、AI 可点击事件链接、可编辑摘要、第二字体、键盘无障碍。945 个测试。
...
- **代码质量优先于功能数量。** TypeScript 严格模式，945 个测试，单向依赖分层。代码库应该经得起时间考验。
...
| 测试 | Vitest 4 + React Testing Library + fake-indexeddb | 945 个测试，56 个测试文件 |
