...
> **注意：** 预构建的 exe / apk 会滞后于最新代码。想体验最新功能请用 `npx cailens` 或从源码构建。
...
自由使用、学习、修改、再分发；但**任何衍生作品、或基于本项目对外提供的网络服务，都必须以 AGPL-3.0 开源其完整源代码**。如需在闭源 / 商业产品中集成，请联系作者获取商业授权。完整条款见 LICENSE。
