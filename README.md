...
> **状态：** v3.9 设置页模块化重构 + 统计页简化。354 个测试。
...
- **代码质量优先于功能数量。** TypeScript 严格模式，354 个测试，单向依赖分层。代码库应该经得起时间考验。
...
| 测试 | Vitest 4 + React Testing Library + fake-indexeddb | 354 个测试，21 个测试文件 |
