...
> **状态：** v3.15.0 标准周视图 + 跨天事件渲染修复——按分钟权重聚合历史周、时段习惯可视化、数据范围/隐藏睡眠控制。465 个测试。
...
- **代码质量优先于功能数量。** TypeScript 严格模式，465 个测试，单向依赖分层。代码库应该经得起时间考验。
...
| 测试 | Vitest 4 + React Testing Library + fake-indexeddb | 465 个测试，27 个测试文件 |
